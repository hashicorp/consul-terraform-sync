...
* Changed default service name in service registration configuration from `Consul-Terraform-Sync` to `consul-terraform-sync` (https://github.com/hashicorp/tutorials/pull/402#discussion_r883929477)
