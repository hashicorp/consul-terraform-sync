...
func (c *taskCreateCommand) Run(args []string) int {
	...
	taskResp, err := client.CreateTaskSimple(context.Background(), api.RunOptionInspect, taskReq)
	...
	taskResp, err = client.CreateTaskSimple(context.Background(), api.RunOptionNow, taskReq)
