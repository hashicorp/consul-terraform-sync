...
// NewTerraformExec creates a new instance of TerraformExec. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTerraformExec(t testing.TB) *TerraformExec {
	mock := &TerraformExec{}
	mock.Mock.Test(t)
