...
// NewConsulClientInterface creates a new instance of ConsulClientInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewConsulClientInterface(t testing.TB) *ConsulClientInterface {
