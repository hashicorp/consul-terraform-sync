...
func (_m *ClientWithResponsesInterface) CreateTaskWithBodyWithResponse(ctx context.Context, params *oapigen.CreateTaskParams, contentType string, body io.Reader, reqEditors ...oapigen.RequestEditorFn) (*oapigen.CreateTaskResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateTaskWithBodyWithResponse")
	}

	var r0 *oapigen.CreateTaskResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *oapigen.CreateTaskParams, string, io.Reader, ...oapigen.RequestEditorFn) (*oapigen.CreateTaskResponse, error)); ok {
...
func (_m *ClientWithResponsesInterface) CreateTaskWithResponse(ctx context.Context, params *oapigen.CreateTaskParams, body oapigen.TaskRequest, reqEditors ...oapigen.RequestEditorFn) (*oapigen.CreateTaskResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateTaskWithResponse")
	}

	var r0 *oapigen.CreateTaskResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *oapigen.CreateTaskParams, oapigen.TaskRequest, ...oapigen.RequestEditorFn) (*oapigen.CreateTaskResponse, error)); ok {
...
func (_m *ClientWithResponsesInterface) DeleteTaskByNameWithResponse(ctx context.Context, name string, reqEditors ...oapigen.RequestEditorFn) (*oapigen.DeleteTaskByNameResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteTaskByNameWithResponse")
	}

	var r0 *oapigen.DeleteTaskByNameResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...oapigen.RequestEditorFn) (*oapigen.DeleteTaskByNameResponse, error)); ok {
...
func (_m *ClientWithResponsesInterface) GetAllTasksWithResponse(ctx context.Context, reqEditors ...oapigen.RequestEditorFn) (*oapigen.GetAllTasksResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAllTasksWithResponse")
	}

	var r0 *oapigen.GetAllTasksResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...oapigen.RequestEditorFn) (*oapigen.GetAllTasksResponse, error)); ok {
...
func (_m *ClientWithResponsesInterface) GetClusterStatusWithResponse(ctx context.Context, reqEditors ...oapigen.RequestEditorFn) (*oapigen.GetClusterStatusResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetClusterStatusWithResponse")
	}

	var r0 *oapigen.GetClusterStatusResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...oapigen.RequestEditorFn) (*oapigen.GetClusterStatusResponse, error)); ok {
		return rf(ctx, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...oapigen.RequestEditorFn) *oapigen.GetClusterStatusResponse); ok {
		r0 = rf(ctx, reqEditors...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*oapigen.GetClusterStatusResponse)
		}
	}
...
func (_m *ClientWithResponsesInterface) GetHealthWithResponse(ctx context.Context, reqEditors ...oapigen.RequestEditorFn) (*oapigen.GetHealthResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...oapigen.RequestEditorFn) (*oapigen.GetHealthResponse, error)); ok {
		return rf(ctx, reqEditors...)
	}
...
func (_m *ClientWithResponsesInterface) GetTaskByNameWithResponse(ctx context.Context, name string, reqEditors ...oapigen.RequestEditorFn) (*oapigen.GetTaskByNameResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTaskByNameWithResponse")
	}

	var r0 *oapigen.GetTaskByNameResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...oapigen.RequestEditorFn) (*oapigen.GetTaskByNameResponse, error)); ok {
		return rf(ctx, name, reqEditors...)
	}
