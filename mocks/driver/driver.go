...
func (_m *Driver) ApplyTask(ctx context.Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for ApplyTask")
	}
...
func (_m *Driver) InitTask(ctx context.Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for InitTask")
	}
...
func (_m *Driver) InspectTask(ctx context.Context) (driver.InspectPlan, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for InspectTask")
	}
...
// SetBufferPeriod provides a mock function with no fields
...
// TemplateIDs provides a mock function with no fields
func (_m *Driver) TemplateIDs() []string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for TemplateIDs")
	}
