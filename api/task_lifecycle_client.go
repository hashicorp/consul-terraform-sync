...
//go:generate go run github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen -package oapigen -old-config-style -generate client -o oapigen/client.go openapi.yaml
